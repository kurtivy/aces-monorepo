    ...
    <style jsx>
      {`
        ...
        @keyframes goldenNeonFlicker {
          0%,
          100% {
            filter: drop-shadow(0 0 4px #d0b284) drop-shadow(0 0 8px #d7bf75)
              drop-shadow(0 0 12px rgba(215, 191, 117, 0.4));
          }
          50% {
            filter: drop-shadow(0 0 6px #d0b284) drop-shadow(0 0 12px #d7bf75)
        ...
        @keyframes goldenGlow {
          0%,
          100% {
            filter: drop-shadow(0 0 8px #d7bf75) drop-shadow(0 0 16px rgba(215, 191, 117, 0.3));
          }
          50% {
            filter: drop-shadow(0 0 12px #d7bf75) drop-shadow(0 0 24px rgba(215, 191, 117, 0.4));
          }
        }
