        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="relative w-full max-w-md rounded-2xl border border-[#D0B264]/30 bg-[#0B0F0B] p-6 shadow-2xl"
            >
              {/* Close button */}
              <button
                onClick={onClose}
                className="absolute right-4 top-4 rounded-lg p-1 text-[#D0B264]/60 transition-colors hover:bg-[#D0B264]/10 hover:text-[#D0B264]"
              >
                <X className="h-5 w-5" />
              </button>
              ...
              {/* Title */}
              <h2 className="mb-2 text-center text-2xl font-bold text-[#D0B264]">
              ...
              <div className="space-y-3 rounded-xl border border-[#D0B264]/20 bg-black/40 p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-sm font-semibold text-[#D0B264]">
                    {parseFloat(acesSpent).toFixed(4)} ACES
                  </span>
                </div>
