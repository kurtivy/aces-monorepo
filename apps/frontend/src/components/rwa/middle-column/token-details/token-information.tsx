    ...
    <div className="bg-black rounded-xl overflow-hidden">
      <div className="flex flex-col w-full">
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="">
            {/* Token Price Header */}
            <div className="w-full border border-[#D0B284]/30 rounded-xl">
              <div className="flex items-center justify-between p-2.5 px-4 bg-[#231F20] rounded-xl">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-[#DCDDCC] font-mono">{selectedTimeframe} Vol:</span>
            ...
            <div className="grid grid-cols-2">
              <div className="bg-[#231F20]/50 border border-[#D0B284]/30 shadow-md shadow-black/15 rounded-xl">
                <div className="p-1.5 text-center">
                  <div className="flex items-center justify-center">
                    <TrendingUp className="h-3 w-3 text-[#D0B284]" />
                    <span className="text-xs text-[#DCDDCC] font-mono">FDV</span>
                  </div>
                  <span className="font-mono text-white text-xs font-medium">{fdv}</span>
                </div>
              </div>
              ...
              <div className="bg-[#231F20]/50 border border-[#D0B284]/30 shadow-md shadow-black/15 rounded-xl">
                <div className="p-1.5 text-center">
                  <div className="flex items-center justify-center">
                    <Droplets className="h-3 w-3 text-[#D0B284]" />
                    <span className="text-xs text-[#DCDDCC] font-mono">Liquidity</span>
                  </div>
                  <span className="font-mono text-white text-xs font-medium">{liquidity}</span>
                </div>
              </div>
              ...
              <div className="bg-[#231F20]/50 border border-[#D0B284]/30 shadow-md shadow-black/15 rounded-xl">
                <div className="p-1.5 text-center">
                  <div className="flex items-center justify-center">
                    <Users className="h-3 w-3 text-[#D0B284]" />
              ...
              <div className="bg-[#231F20]/50 border border-[#D0B284]/30 shadow-md shadow-black/15 rounded-xl">
                <div className="p-1.5 text-center">
                  ...
                  <span className="font-mono text-white text-xs font-medium">{volume['1d']}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full bg-[#231F20]/30 rounded-xl">
              ...
              <div className="flex flex-row ">
                {Object.entries(priceChange).map(([time, change]) => (
                  <button
                    ...
                    className={`flex-1 rounded-xl p-1.5 text-center border transition-all duration-200 shadow-sm bg-[#231F20] ${
                      selectedTimeframe === time
                        ? 'border-[#184D37] bg-[#184D37]/50 shadow-[#184D37]/20'
                        : 'border-[#D0B284]/20 hover:border-[#D0B284]/40 hover:bg-[#D0B284]/5'
                    }`}
                  >
                    <div className="text-sm mb-0.5 text-[#D0B284] font-mono font-medium">
                      {time}
                    </div>
                    <div
