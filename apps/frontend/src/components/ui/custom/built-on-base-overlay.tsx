...
const BuiltOnBaseOverlayComponent: React.FC = () => {
    ...
    <>
      <div
        className={`
          ...
          cursor-pointer hover:bg-black/90 hover:border-[#D0B264]/60
        `}
        style={{
...
const BuiltOnBaseOverlay = memo(BuiltOnBaseOverlayComponent);

export default BuiltOnBaseOverlay;
