...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const directives = [
      ...
      "base-uri 'self'",
      "object-src 'none'",
      `script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://challenges.cloudflare.com${isCloudflareEnabled ? ' https://static.cloudflareinsights.com' : ''} https://*.clarity.ms https://www.googletagmanager.com https://va.vercel-scripts.com https://vercel.live https://auth.privy.io https://charting-library.tradingview-widget.com https://*.tradingview.com`,
      `script-src-elem 'self' 'unsafe-inline' blob:${isCloudflareEnabled ? ' https://static.cloudflareinsights.com' : ''} https://*.clarity.ms https://www.googletagmanager.com https://va.vercel-scripts.com https://vercel.live https://auth.privy.io https://charting-library.tradingview-widget.com https://*.tradingview.com`,
      ...
      'frame-src https://auth.privy.io https://verify.walletconnect.com https://verify.walletconnect.org https://challenges.cloudflare.com https://*.clarity.ms blob: data: https://*.tradingview.com https://charting-library.tradingview-widget.com https://dexscreener.com https://*.dexscreener.com https://vercel.live',
