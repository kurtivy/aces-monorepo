...
export const DUAL_CURRENCY_BONDING_CURVE_TOKEN_ABI = [
  {
    inputs: [],
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        internalType: 'uint256',
        name: '_totalETHRaised',
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: '_totalUSDCRaised',
        type: 'uint256',
      },
      {
        internalType: 'uint256',
...
// Backend still needs this ABI for the old contract structure
export const MOCK_RWA_FACTORY_ABI = [
  {
    inputs: [
      {
        internalType: 'address',
