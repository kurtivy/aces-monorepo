export declare const ACES_TOKEN_ABI: readonly [{
    ...
    readonly inputs: readonly [{
        readonly indexed: false;
        readonly internalType: "uint256";
        readonly name: "attemptedMintAmount";
        readonly type: "uint256";
    }];
    ...
    readonly inputs: readonly [];
    readonly name: "remainingMintableSupply";
    readonly outputs: readonly [{
        readonly internalType: "uint256";
        readonly name: "";
        readonly type: "uint256";
...
export declare const MOCK_RWA_DEED_NFT_ABI: readonly [{
    readonly inputs: readonly [{
        readonly internalType: "address";
...
export declare const MOCK_BONDING_CURVE_TOKEN_ABI: readonly [{
    readonly inputs: readonly [{
        readonly internalType: "string";
        readonly name: "";
        readonly type: "string";
    ...
    readonly name: "OutputAmountTooLow";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    ...
    readonly inputs: readonly [{
        readonly indexed: true;
        readonly internalType: "address";
        readonly name: "currentFactory";
        readonly type: "address";
    }, {
        readonly indexed: true;
        readonly internalType: "address";
        readonly name: "pendingFactory";
        readonly type: "address";
    }];
    readonly name: "FactoryTransferStarted";
    readonly type: "event";
}, {
    readonly anonymous: false;
    readonly inputs: readonly [{
    ...
    readonly name: "FactoryTransferred";
    readonly type: "event";
}, {
    readonly anonymous: false;
    readonly inputs: readonly [{
    ...
    readonly inputs: readonly [{
        readonly indexed: false;
        readonly internalType: "uint256";
        readonly name: "ownerFees";
        readonly type: "uint256";
    }, {
        readonly indexed: false;
        readonly internalType: "uint256";
        readonly name: "platformFees";
        readonly type: "uint256";
    }];
    ...
    readonly inputs: readonly [];
    readonly name: "platformFeesAccrued";
    readonly outputs: readonly [{
        readonly internalType: "uint256";
        readonly name: "";
        readonly type: "uint256";
    ...
    readonly inputs: readonly [{
        readonly internalType: "address";
        readonly name: "_newFactory";
        readonly type: "address";
    }];
    readonly name: "transferFactory";
    readonly outputs: readonly [];
    readonly stateMutability: "nonpayable";
    readonly type: "function";
}, {
...
export declare const ABIS: {
    ...
    readonly MockRwaDeedNft: readonly [{
        readonly inputs: readonly [{
            readonly internalType: "address";
            readonly name: "initialOwner";
            readonly type: "address";
    ...
    readonly MockBondingCurveToken: readonly [{
        readonly inputs: readonly [{
            readonly internalType: "string";
            readonly name: "";
            readonly type: "string";
