/**
 * TermsModal -- Full-screen modal displaying ACES legal documents.
 *
 * Ported from the Next.js frontend (apps/frontend) to the Vite/SPA frontend.
 *
 * Key decisions:
 *  - 'use client' directive removed (not needed in Vite/SPA).
 *  - TermsModalTab type defined locally instead of importing from modal-context.
 *  - useModal context dependency removed; component accepts isOpen/onClose/initialTab props.
 *  - Hardcoded hex colors replaced with Tailwind design-system classes:
 *      #D0B264 / #D0B284 / #D7BF75  -> text-golden-beige, border-golden-beige, bg-golden-beige
 *      black backgrounds             -> bg-deep-charcoal (page) / bg-card-surface (elevated)
 *      gray text                     -> text-platinum-grey with opacity variants
 *  - font-neue-world -> font-heading (maps to Instrument Serif in this frontend).
 *  - framer-motion kept as-is (already a dependency).
 *  - ALL legal text preserved verbatim -- Terms of Service, Privacy Policy, Launchpad Agreement.
 *
 * Three tabs:
 *  1. Terms of Service
 *  2. Privacy Policy
 *  3. Launchpad Agreement
 */
...
/** The three tabs available in the terms modal. */
type TermsModalTab = 'terms' | 'privacy' | 'launchpad';
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="max-w-3xl w-full max-h-[90vh] bg-deep-charcoal rounded-lg shadow-lg border border-golden-beige/40 overflow-hidden">
              {/* Header */}
              <div className="flex items-center justify-between p-6 border-b border-golden-beige/20">
                <h1 className="text-3xl font-heading font-bold text-white">Legal Information</h1>
                <button
                  onClick={onClose}
                  className="text-golden-beige hover:text-white transition-colors duration-200"
                >
                  <X className="w-6 h-6" />
                </button>
              </div>
              ...
              {/* Tab Navigation */}
              <div className="p-6 border-b border-golden-beige/20">
                <div className="flex justify-center">
                  <div className="bg-card-surface rounded-full p-1 border border-golden-beige/30 w-full max-w-sm sm:max-w-2xl">
                    <div className="flex space-x-1">
                      <button
                        ...
                        className={`flex-1 px-3 py-2 sm:px-8 sm:py-3 rounded-full text-sm sm:text-lg font-heading font-semibold transition-all duration-300 ${
                          activeTab === 'terms'
                            ? 'bg-golden-beige text-black shadow-lg'
                            : 'text-platinum-grey/50 hover:text-golden-beige hover:bg-golden-beige/10'
                        }`}
                      >
                        Terms of Service
                      </button>
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
                <div className="space-y-6 pt-4">
                  {activeTab === 'terms' ? (
                    <div className="text-platinum-grey/80 space-y-6">
                      <div className="space-y-8">
                        <div className="text-center mb-4">
                          <h2 className="text-2xl font-heading font-bold text-golden-beige mb-2">
                            Terms of Use
                          </h2>
                          <p className="text-golden-beige text-lg">Effective Date: June 13, 2025</p>
                        </div>

                        <section>
                          <h2 className="text-xl font-heading font-semibold text-golden-beige mb-3">
                          ...
                          <p className="font-semibold text-golden-beige mb-3">
                        ...
                        <section>
                          ...
                          <p>
                            ...
                            <a
                              ...
                              className="text-golden-beige hover:underline"
                            >
                              legal@aces.fun
                            </a>
                          </p>
                    ...
                    <div className="text-platinum-grey/80 space-y-6">
                      <div className="space-y-8">
                        <div className="text-center mb-4">
                          ...
                          <p className="text-golden-beige text-lg">Last updated: October 21, 2025</p>
                        </div>
                        ...
                        <section className="border-t border-golden-beige/30 pt-6 mt-6">
                          <h2 className="text-xl font-heading font-semibold text-golden-beige mb-3">
                            Governing Law
                          </h2>
                          <p>
                    ...
                    <div className="text-platinum-grey/80 space-y-6">
                      <div className="space-y-8">
                        ...
                        <section>
                          ...
                          <p className="font-semibold text-golden-beige">
